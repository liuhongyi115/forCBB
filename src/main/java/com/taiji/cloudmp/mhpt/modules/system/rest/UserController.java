...
import com.taiji.cloudmp.mhpt.config.DataScope;
import com.taiji.cloudmp.domain.Picture;
import com.taiji.cloudmp.domain.VerificationCode;
import com.taiji.cloudmp.exception.BadRequestException;
import com.taiji.cloudmp.mhpt.modules.system.domain.vo.UserPassVo;
...
import com.taiji.cloudmp.service.PictureService;
import com.taiji.cloudmp.service.VerificationCodeService;
import com.taiji.cloudmp.utils.EncryptUtils;
import com.taiji.cloudmp.utils.PageUtil;
import com.taiji.cloudmp.utils.SecurityUtils;
import com.taiji.cloudmp.utils.YwptConstant;
...
public class UserController {
    ...
    public ResponseEntity updateEmail(@PathVariable String code,@RequestBody User user){
        ...
        VerificationCode verificationCode = new VerificationCode(code, YwptConstant.RESET_MAIL,"email",user.getEmail());
