package com.taiji.cloudmp.mhpt.modules.monitor.service.impl;

import com.taiji.cloudmp.mhpt.modules.monitor.domain.Visits;
import com.taiji.cloudmp.mhpt.modules.monitor.service.VisitsService;
import com.taiji.cloudmp.repository.LogRepository;
import com.taiji.cloudmp.utils.StringUtils;
import lombok.extern.slf4j.Slf4j;
import com.taiji.cloudmp.mhpt.modules.monitor.repository.VisitsRepository;
...
//    private LogRepository logRepository;
    ...
    public void save() {
        ...
        if(visits == null){
            visits = new Visits();
            visits.setCreateTime(new Timestamp(new Date().getTime()));
    ...
    public void count(HttpServletRequest request) {
        ...
        visitsRepository.update(visits);
    }
